...
ages.to_csv(r'../../data/processed/' + 'ages.txt', index=False)
labels.to_csv(r'../../data/processed/' + 'labels.txt', index=False)
with open(r'../../data/interim/' + 'texts.txt', 'w', encoding='utf-8') as file:
